...
| Address  | Pune, India               |
| Timezone | GMT+5:30                  |
| E-mail   | girishvishnuc98@gmail.com |
...
If you want to find me on social media, just search for **@girishcx07**. That's my username on almost all platforms, so it should be easy to find me.

But if you're short on time, I've included some links to the social media platforms I use most frequently below.

| Social Media | Profile URL                        |
| ------------ | ---------------------------------- |
| LinkedIn     | https://linkedin.com/in/girishcx07 |
| Twitter      | https://twitter.com/girishcx07     |
| Instagram    | https://instagram.com/girishcx07   |
