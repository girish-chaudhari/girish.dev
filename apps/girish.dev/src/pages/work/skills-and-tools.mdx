...
Even though the scope of web development is broad, I was very interested and focused on **Software Development** and **UI/UX Design**.
...
I've been using it **since 2021 ({2022 - 2018} years)** and have become quite proficient with it.

### Tailwind CSS

For now, I love using Tailwind CSS for styling, even though I've been using SCSS for a longer time ({2022 - 2021} years).
...
<VStack spacing={12}>
  ...
  <HStack spacing={8}>
    ...
    <Label indicator={30}>Framer Motion</Label>
    <Label indicator={45}>Redux</Label>
    <Label indicator={35}>Webpack</Label>
  </HStack>
  <HStack spacing={8}>
    <Label indicator={35}>Express</Label>
    <Label indicator={25}>Redis</Label>
    <Label indicator={35}>MongoDB</Label>
  </HStack>
</VStack>
